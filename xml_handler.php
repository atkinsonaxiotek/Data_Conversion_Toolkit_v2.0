						...
						<div id="content">
							...
							<!-- Content -->
								<article>
									...
									<form action="xml_handler2.php" method="post" enctype="multipart/form-data">
                                                                            Name:
                                                                            ...
                                                                            Select data source:
                                                                                    <?php
                                                                                        ...
                                                                                        else {echo 'Error Loading Affiliate List - ' . mysqli_error($conn);}
                                                                            ...
                                                                            <input type="file" name="XMLfileToUpload" id="XMLfileToUpload" style="width: 800px"><br>
