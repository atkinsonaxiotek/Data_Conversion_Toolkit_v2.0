						...
						<div id="content">
							...
							<!-- Content -->
								<article>
                                                                        ...
                                                                        <h3>Validate and import the XML file.</h3>
                                                                            <?php

                                                                                //Get data posted by user:           //This section must still be secured for SQL and HTML use
                                                                                $_SESSION["original_filename"] = basename($_FILES["XMLfileToUpload"]["name"]);
                                                                                ...
                                                                                $filePresent = uploadFile("XMLfileToUpload",$_SESSION["target_filename"],"xml"); //this function calls echo original filename.
                                                                                ...
                                                                                DisplayMsg('All files assocaited with job <b>' . $_SESSION["jobName"] . '</b> will have the following prefix: <i><b>' . $_SESSION["uniqueFilename"] . '</b></i><br>',"I");
                                                                                
                                                                                //Display button:
                                                                                if ($filePresent) {
                                                                                    echo "Next, import the file.<br>";
                                                                                    echo '<form action="xml_handler3.php" method="post">';
