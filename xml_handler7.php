								...
								<article>
									...
									<h3>Download your new files.</h3>
                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            //Set variables
                                                                            $old_file = $_SESSION["target_filename"];
                                                                            $intermediate_file = "intermediate_files/" . "intermediate_" . $_SESSION["uniqueFilename"] . ".xml";
                                                                            $new_file = "new_files/" . $_SESSION["uniqueFilename"] . ".xml";

                                                                            //Write the new file
                                                                            removeTopLevelSections($old_file,$intermediate_file,$_SESSION["arrayOfUnwantedTags"],$_SESSION["log_fileLocation"]);
                                                                            changeProviderNamesAndIDs($intermediate_file,$new_file,$_SESSION["log_fileLocation"]);
